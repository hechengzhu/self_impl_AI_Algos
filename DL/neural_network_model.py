...
class NeuralNetwork(object):
           ...
           for i in range(len(training_X)):
               ...
               for j in range(len(w32)):
                   ...
                   for k in range(len(w32[j])):
                       ...
                       if c_hat > 0:
                           activition_deriv = 1
                       c_derivative = loss_value * activition_deriv * hidden_vector[k]
               ...
               for j in range(len(w21)):
                   ...
                   for k in range(len(w21[j])):
                       ...
                       if hidden_vector[j] > 0:
                           activition_deriv = 1
                       h_derivative = w32_deriv[j] * activition_deriv * X_vector[k]
    ...
    def predict(self, test_X, w21, w32):
        for i in range(len(test_X)):
            ...
            for j in range(len(w32)):
                count = 0.0
                for k in range(len(w32[j])):
                    count += self.__activation(a[k] * w32[j][k])
                out_value = count
            print(out_value)
    ...
    def __forward_pass(self, training_X, training_y, w21, w32, epo):
        ...
        for j in range(len(w21)):
            ...
            # Activation function
            temp_a = self.__activation(temp_a)
        ...
        for j in range(len(w32)):
            ...
            temp_c = self.__activation(temp_c)
            output_value = temp_c
...
if __name__ == "__main__":
    ...
    neural_network = NeuralNetwork(3, 3, 0.0001, 50)
